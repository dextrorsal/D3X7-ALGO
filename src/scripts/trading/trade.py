...
def main():
    ...
    parser.add_argument("--network", default="mainnet", choices=["mainnet", "devnet"],
                        help="Network to trade on (mainnet or devnet)")
    
    # Trading mode
    parser.add_argument("--mode", choices=["continuous", "single", "paper", "test"], default="paper",
                       help="Trading mode: continuous, single cycle, paper trading, or devnet test")
    
    # Devnet test settings
    parser.add_argument("--deposit-amount", type=float, default=0.1,
