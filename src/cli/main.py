...
from .trading.devnet import DevnetCLI
...
class D3X7CLI:
    ...
    def __init__(self, config: Optional[Config] = None):
        ...
        self.devnet_cli = DevnetCLI(self.config)
    ...
    def create_parser(self):
        ...
        self.devnet_cli.add_arguments(subparsers)
    ...
    async def handle_command(self, args):
        ...
        try:
            ...
            elif args.command == 'devnet':
                await self.devnet_cli.handle_command(args)
