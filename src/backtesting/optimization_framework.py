...
class StrategyOptimizer:
    """
    A framework for optimizing and validating trading strategies using the four-step process:
    1. Insample Excellence (optimization)
    2. Insample Monte Carlo Permutation Test
    3. Walk Forward Test
    ...
    def summary(self) -> str:
        ...
        summary = "TRADING STRATEGY OPTIMIZATION SUMMARY\n"
        summary += "=" * 40 + "\n\n"
